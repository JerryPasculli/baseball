...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._txtSquadre = ft.ListView(expand=1, spacing=10, padding=20, auto_scroll=False)
        self._ddAnno = ft.Dropdown(label="Anno", width=200, alignment=ft.alignment.top_left, on_change=self._controller.popola)
        ...
        cont = ft.Container(self._txtSquadre, width=300, height= 200, alignment=ft.alignment.top_left, bgcolor="#deeded")
        ...
        self._btnPercorso = ft.ElevatedButton(text="Percorso", disabled=True, on_click=self._controller.handlePercorso)
        ...
        for i in range(0,200):
            self._txtSquadre.controls.append(ft.Text(f"Squadra {i}"))
